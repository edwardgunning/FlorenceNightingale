...
class: center
background-image: url("ScienceOnAPostcard.png")
...
mort %>% 
  ...
  mutate(english_rate=(d_english/n_english)*1000) %>%
  select(c(1,6,7,8)) %>%
...
---
.center[
# Learn from Nightingale
]

1. <b>Quality Data </b>- Tidy datasets are easy to manipulate, model and visualise.
  
--

2. <b>Reproducibility</b> - Circa 160 years later the diagrams are entirely reproducible. 

--

3. <b>Nightingale's annotations</b> - A perfect exemplar for SciComm today.
...
From Hadley Wickham's ['A Layered Grammar of Graphics'](http://vita.had.co.nz/papers/layered-grammar.html):
.center[
.midtext[
